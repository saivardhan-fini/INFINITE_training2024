...
namespace OOPS
{
    public class Accounts
    {
        ...
        {
            Accounts account = new Accounts(1035473, "SAI", "Savings", "d", 0, 45000);
            Console.WriteLine("Initial account data:");
            account.Show();

            Console.WriteLine("\nPerforming a deposit of 10000.....");
            account.UpdateBalance("d", 10000);
            account.Show();

            Console.WriteLine("\nPerforming a withdrawal of 2000....");
            account.UpdateBalance("w", 2000);
            account.Show();

            Console.WriteLine("\nAttempting an invalid transaction type...");
            account.UpdateBalance("x", 10000);
            account.Show();
